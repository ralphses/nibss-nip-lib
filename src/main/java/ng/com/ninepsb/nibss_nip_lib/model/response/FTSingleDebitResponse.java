...
/**
 * 015 Fund Transfer Response (Direct Debit) (FTSingleDebitResponse)
 * Extends BaseResponse.
 */
@Data
@EqualsAndHashCode(callSuper = true)
@XmlRootElement(name = "FTSingleDebitResponse", namespace = "http://core.nip.nibss/")
@XmlAccessorType(XmlAccessType.FIELD)
public class FTSingleDebitResponse extends BaseResponse {
