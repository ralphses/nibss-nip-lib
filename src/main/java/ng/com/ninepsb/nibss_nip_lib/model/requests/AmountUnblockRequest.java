...
import ng.com.ninepsb.nibss_nip_lib.model.response.AmountUnblockResponse;
...
@NipRequestItem(request = AmountUnblockRequest.class, response = AmountUnblockResponse.class)
