...
/**
 * 021 Fund Transfer Advice Response (Direct Credit) (FTAdviceCreditResponse)
 * Extends BaseResponse.
 */
@Data
@EqualsAndHashCode(callSuper = true)
@XmlRootElement(name = "FTAdviceCreditResponse", namespace = "http://core.nip.nibss/")
@XmlAccessorType(XmlAccessType.FIELD)
public class FTAdviceCreditResponse extends BaseResponse {
