...
/**
 * 029 Account Block Response (AccountBlockResponse)
 * Extends BaseResponse.
 */
@Data
@EqualsAndHashCode(callSuper = true)
@XmlRootElement(name = "AccountBlockResponse", namespace = "http://core.nip.nibss/")
@XmlAccessorType(XmlAccessType.FIELD)
public class AccountBlockResponse extends BaseResponse {
