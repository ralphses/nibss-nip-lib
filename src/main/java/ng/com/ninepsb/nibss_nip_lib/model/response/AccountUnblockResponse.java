...
/**
 * 031 Account Unblock Response (AccountUnblockResponse)
 * Extends BaseResponse.
 */
@Data
@EqualsAndHashCode(callSuper = true)
@XmlRootElement(name = "AccountUnblockResponse", namespace = "http://core.nip.nibss/")
@XmlAccessorType(XmlAccessType.FIELD)
public class AccountUnblockResponse extends BaseResponse {
