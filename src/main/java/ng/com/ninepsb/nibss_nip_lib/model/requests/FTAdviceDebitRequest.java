...
import ng.com.ninepsb.nibss_nip_lib.model.response.FTAdviceDebitResponse;
...
@NipRequestItem(request = FTAdviceDebitRequest.class, response = FTAdviceDebitResponse.class)
