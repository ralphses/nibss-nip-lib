...
/**
 * 025 Amount Block Response (AmountBlockResponse)
 * Extends BaseResponse.
 */
@Data
@EqualsAndHashCode(callSuper = true)
@XmlRootElement(name = "AmountBlockResponse", namespace = "http://core.nip.nibss/")
@XmlAccessorType(XmlAccessType.FIELD)
public class AmountBlockResponse extends BaseResponse {
