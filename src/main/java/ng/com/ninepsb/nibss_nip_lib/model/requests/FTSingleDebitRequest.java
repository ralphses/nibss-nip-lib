...
import ng.com.ninepsb.nibss_nip_lib.model.response.FTSingleDebitResponse;
...
/**
 * 014 Fund Transfer Request (Direct Debit) (FTSingleDebitRequest)
 * Extends BaseTransaction.
 */
@Data
@EqualsAndHashCode(callSuper = true)
@XmlRootElement(name = "FTSingleDebitRequest", namespace = "http://core.nip.nibss/")
@XmlAccessorType(XmlAccessType.FIELD)
@NipRequestItem(request = FTSingleDebitRequest.class, response = FTSingleDebitResponse.class)
public class FTSingleDebitRequest extends BaseTransaction {
